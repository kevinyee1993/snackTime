...
class Game {
  ...
  constructor(options) {
    ...
    this.failSound = new __WEBPACK_IMPORTED_MODULE_2__sound__["a" /* default */]("assets/sounds/buzz-tone.mp3");
...
class FallBlock extends __WEBPACK_IMPORTED_MODULE_0__square__["a" /* default */] {
  ...
  drawFish(ctx) {
    ...
    ctx.drawImage(image,10,-40,200,200,this.xPos,this.yPos,50,50);
  }
